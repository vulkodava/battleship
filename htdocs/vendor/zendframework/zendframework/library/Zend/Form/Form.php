...
class Form extends Fieldset implements FormInterface
{
    ...
    /**
     * Prepare the validation group in case Collection elements were used (this function also handle the case where
     * elements could have been dynamically added or removed from a collection using JavaScript)
     *
