...
class Maildir extends Folder\Maildir implements WritableInterface
{
     ...
     *
     * @param   array $flags wanted flags, with the reference you'll get the set flags with correct key (= char for
     *                       flag)
     * @throws \Zend\Mail\Storage\Exception\InvalidArgumentException
     ...
     * @param   null|string|\Zend\Mail\Storage\Folder $folder       folder for new message, else current folder is
     *                                                              taken
     * @param   null|array $flags                                   set flags for new message, else a default set is
     *                                                              used
